...
+(double)getSunLongitude:(int)jdn timeZone:(int)timeZone
{
...
+(int)getLeapMonthOffset:(int)a11 timeZone:(int)timeZone
{
    ...
    arc = (int)([self getSunLongitude:[self getNewMoonDay:k+i timeZone:timeZone ] timeZone:timeZone ]);
    do {
        last = arc;
        i++;
        arc = (int)([self getSunLongitude:[self getNewMoonDay:k+i timeZone:timeZone ] timeZone:timeZone ]);
...
+(long)getLunarMonth11:(int)yy timeZone:(int)timeZone
{
...
{
    long k, dayNumber, monthStart, a11, b11, diff, leapMonthDiff, lunarDay, lunarMonth, lunarYear, lunarLeap;
